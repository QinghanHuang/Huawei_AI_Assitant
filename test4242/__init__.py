...
TEST_SETS = [
        ...
        'validation-data/danger',
        'validation-data/example-data',
        'validation-data/sql-murder-mystery',
        'validation-data/tallest_buildings_global',
        'validation2-data/danger',
        'validation2-data/example-data',
        'validation3-data/danger',
]
